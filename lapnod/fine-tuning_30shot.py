...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[dict(method='MetaRCNN', setting='SPLIT1_30SHOT')],
            num_novel_shots=30,
            num_base_shots=30,
...
evaluation = dict(interval=100, metric='mAP', class_splits=['BASE_CLASSES_SPLIT1', 'NOVEL_CLASSES_SPLIT1'])
...
log_level = 'INFO'
load_from = 'results/base_r50/latest.pth'
resume_from = None
workflow = [('train', 1)]
