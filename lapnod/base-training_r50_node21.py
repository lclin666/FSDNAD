...
# dataset settings
img_norm_cfg = dict(
#    mean=[123.653, 123.653, 123.653], std=[1.0, 1.0, 1.0], to_rgb=False) # lapnod
    mean=[144.452, 144.452, 144.452], std=[1.0, 1.0, 1.0], to_rgb=False) # node21
    ...
    query=[
        ...
        dict(
             ...
             img_scale=[(1333, 480), (1333, 512), (1333, 544), (1333, 576),
                        ...
                        (1333, 736), (1333, 768), (1333, 800), (1333, 1024)],
             keep_ratio=True,
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_cfg=[
                dict(
                    type='ann_file',
                    ann_file=data_root + 'VOC2007/ImageSets/Main/train_node21.txt')
            ],
    ...
    val=dict(
        ...
        ann_cfg=[
            dict(
                type='ann_file',
                ann_file=data_root + 'VOC2007/ImageSets/Main/val_node21.txt')
        ],
        img_prefix=data_root,
...
seed = 42
work_dir = './results/base_r50_node21'
